...
filedir_glob = 'Z:\Maodong\Projects\Pulse Pumping\AlGaAs\AutoCorrelators\20211007-autocorr-Find-disp3'

center = 193.37;
bandpass = 0.8 ; %THz
disp3_list = 0:0.1:1.5;
disp2 = -5.9;
...
ws.plot_status
ws.write2WS
filedir = strcat(filedir_glob,'\',sprintf('bp_%.3f_THz_disp2_%.3f', bp, disp2),'\');
%%
...
figure
hold on
errorbar(disp3_list,2*dt_list/1e-12,2*dt_error_list/1e-12,'o','DisplayName','EO pulse width')
xlabel('disp2 (ps/nm)')
