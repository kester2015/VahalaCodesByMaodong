classdef TDS3014 < handle
    ...
    methods
        function obj = TDS3014(visaAddress)
            if nargin > 0
        ...
        function connect(Obj)
            ...
            fopen(Obj.visaObj);
            disp('TDS3014 OSCilloscope connected');
        end
        ...
        function disconnect(Obj)
            ...
            if (Obj.isconnected)
                disp('TDS3014 OSCilloscope disconnected');
            end
            fclose(Obj.visaObj);
        end
