...
%
%      DISPERSION_ANALYZER('CA1LLBACK',hObject,eventData,handles,...) calls the local
...
% Last Modified by GUIDE v2.5 21-Jul-2020 19:08:12
...
function ExtractQ_sensitivity_Callback(hObject, eventdata, handles)
% hObject    handle to ExtractQ_sensitivity (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of ExtractQ_sensitivity as text
%        str2double(get(hObject,'String')) returns contents of ExtractQ_sensitivity as a double


% --- Executes during object creation, after setting all properties.
function ExtractQ_sensitivity_CreateFcn(hObject, eventdata, handles)
% hObject    handle to ExtractQ_sensitivity (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
...
function ExtractQ_correction_Callback(hObject, eventdata, handles)
% hObject    handle to ExtractQ_correction (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of ExtractQ_correction as text
%        str2double(get(hObject,'String')) returns contents of ExtractQ_correction as a double


% --- Executes during object creation, after setting all properties.
function ExtractQ_correction_CreateFcn(hObject, eventdata, handles)
% hObject    handle to ExtractQ_correction (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function ExtractQ_plot_interval_Callback(hObject, eventdata, handles)
% hObject    handle to ExtractQ_plot_interval (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of ExtractQ_plot_interval as text
%        str2double(get(hObject,'String')) returns contents of ExtractQ_plot_interval as a double


% --- Executes during object creation, after setting all properties.
function ExtractQ_plot_interval_CreateFcn(hObject, eventdata, handles)
% hObject    handle to ExtractQ_plot_interval (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function ExtractQ_disgard_Callback(hObject, eventdata, handles)
% hObject    handle to ExtractQ_disgard (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of ExtractQ_disgard as text
%        str2double(get(hObject,'String')) returns contents of ExtractQ_disgard as a double


% --- Executes during object creation, after setting all properties.
function ExtractQ_disgard_CreateFcn(hObject, eventdata, handles)
% hObject    handle to ExtractQ_disgard (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
