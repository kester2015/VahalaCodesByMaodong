...
% % %------20200820 Tantala-----------%
%1535nm
filedirGolb = strcat("Z:\Qifan\Tantala\20200820-thermal-rawdata\Dev21\");
...
% outputVoltage1List = [0.960];
% outputPower1List   = [0.5536];%[1.221 1.637 1.846];%mW
% inputVoltage1List  = [2.039];%[1.77296 2.2588 2.4366]; %V
% inputPower1List    = [9.789];%[8.421 11.17 12.17];%mW
% outputVoltage2List = [0.907];%[0.89960 1.2781 1.1564]; %V
% outputPower2List   = [0.4925];%[1.196 1.489 1.704];%mW
% inputVoltage2List  = [2.012];%[1.773 2.1937 2.4256]; %V
% inputPower2List    = [9.380];%[8.548 10.55 12.24];%mW
% % QtotList         = [1.035   0.7445 1.2    0.8831  0.922   0.3973  0.8875  1.568  ]*1e6;
% % QextList         = [2.07    1.769  3.224  4.61    2.907   0.7945  1.934   4.745  ]*1e6;
% % -----updated with FP fitting------
% QtotList           = [1.673]*1e6;
...
% wavelengthList     = [1536];%1535:10:1555;
% outputVoltage1List = [1.651];
% outputPower1List   = [0.9183];%[1.221 1.637 1.846];%mW
% inputVoltage1List  = [3.370];%[1.77296 2.2588 2.4366]; %V
% inputPower1List    = [14.38];%[8.421 11.17 12.17];%mW
% outputVoltage2List = [1.438 ];%[0.89960 1.2781 1.1564]; %V
% outputPower2List   = [0.8606];%[1.196 1.489 1.704];%mW
% inputVoltage2List  = [3.223 ];%[1.773 2.1937 2.4256]; %V
% inputPower2List    = [14.44];%[8.548 10.55 12.24];%mW
% % QtotList         = [1.035   0.7445 1.2    0.8831  0.922   0.3973  0.8875  1.568  ]*1e6;
% % QextList         = [2.07    1.769  3.224  4.61    2.907   0.7945  1.934   4.745  ]*1e6;
% % -----updated with FP fitting------
% QtotList           = [1.005]*1e6;
...
% %1535nm
% filedirGolb = strcat("Z:\Qifan\Tantala\20200820-thermal-rawdata\Dev21\");
% wavelengthList     = [1551   1561];%1535:10:1555;
% outputVoltage1List = [2.332  1.876];
% outputPower1List   = [1.403  1.399];%[1.221 1.637 1.846];%mW
% inputVoltage1List  = [3.490  3.335];%[1.77296 2.2588 2.4366]; %V
% inputPower1List    = [15.80  14.62];%[8.421 11.17 12.17];%mW
% outputVoltage2List = [2.018  1.780];%[0.89960 1.2781 1.1564]; %V
% outputPower2List   = [1.183  1.379];%[1.196 1.489 1.704];%mW
% inputVoltage2List  = [3.497  3.329];%[1.773 2.1937 2.4256]; %V
% inputPower2List    = [15.03  15.29];%[8.548 10.55 12.24];%mW
% QtotList           = [2.096  1.644]*1e6;
% QextList           = [8.754  6.114]*1e6;
% realwavelengthList = [1551.4 1561.0];
% kerrOverTotalList  = [0.0332 0.0353]/2;
% 
% count = 1:length(wavelengthList);
...
% 
% meanSlope(3) = meanSlope(1);
% QextList(3) = 13.9725e6;
% QtotList(3) = 1.4591e6;
% realwavelengthList(3) = realwavelengthList(1);
% kerrOverTotalList(3) = kerrOverTotalList(1);
for count = 1:length(wavelengthList)
    %%
