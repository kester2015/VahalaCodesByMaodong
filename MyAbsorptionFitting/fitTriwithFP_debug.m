...
% clc
%%
Q_data_file = 'Z:\Qifan\Tantala\20200819\Dev21\triangle\4.46uW-1540.4nm.mat';
load('D:\Measurement Data\Tantala summary\1540nm-01-mat\Sweep_20Hz_Power_0.63V.mat','timeAxis','Ch2','Ch3')
...
% findmin_start_point = [fp_fit.A0*(1+r1r2^2), r1r2, fp_fit.x1, fp_fit.T, kappa0, kappae, mid_x(1), 5*alpha_est];
...
findmin_start_point = [mid_x(1), 5*alpha_est];
%         options = optimset('MaxFunEvals',5000);
findmin_fit_result = fminsearch(findmin_fun,findmin_start_point);
