...
%
    wavelength = 1547;
    outputVoltage1 = 2.78; %V
    outputPower1 = 0.336;%mW
    inputPower1 = 2.937;%mW
    outputVoltage2 = 2.827; %V
    outputPower2 = 0.3574;%mW
    inputPower2 = 2.993;%mW
    Q_data_filename = 'Z:\Qifan\AlGaAs\20200915-thermal-rawdata\pol1-1535.4nm.mat';
